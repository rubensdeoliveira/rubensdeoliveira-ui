...
export function Button({
  ...
  switch (variant) {
    ...
    case 'link':
      return (
        <button {...rest} className={`${sharedClassName} font-medium`}>
          {renderButtonContent}
        </button>
      )
    case 'ghost':
      return (
        <button
          {...rest}
          className={`${sharedClassName} bg-transparent border-0 p-2`}
        >
          {renderButtonContent}
        </button>
      )
    ...
    default:
      return (
        <button
          {...rest}
          className={`${sharedClassName} focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 focus:outline-none`}
        >
          {renderButtonContent}
        </button>
      )
